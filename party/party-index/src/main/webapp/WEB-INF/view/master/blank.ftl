    ...
    <div class="menu">
        ...
        <#--可改造 默认两级-->
            <#if list??&&list?size gt 0>
                <#list list as b>
                    <li class="reList"><a  href="${basePath}/list/${b.channelId}">${(b.name)!}</a>
        ...
        <ul class="link1">
            ...
            <li class="right1">
                <form action="${basePath}/search" method="post">
                    <input class="sousuo" name="w" placeholder="站内搜索" style="overflow:hidden;" value="${w!}"></input>
...
<#macro footer>
<div id="footer">
    <p>长春大学计算机科学技术学院 地点：吉林省长春市卫星路6543号</p>
    <p>邮编：130000</p>
</div>
</#macro>