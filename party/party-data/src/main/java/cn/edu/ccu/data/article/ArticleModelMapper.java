...
//    int updateByPrimaryKey(ArticleModel record);
    ...
    int selectArticleByIdsCount1(String title);


    List<ArticleModel> selectArticleByLike(@Param("title") String name, @Param("pageNo") Integer pageNo, @Param("pageSize") Integer pageSize);
