			...
			<form id="searchForm" class="form-inline no-margin" action="${basePath}/student/list" method="post">
                <div class="col-md-8">
                    <div class="form-group col-md-3" style="margin-right:10px;">
                        ...
                        <div>
                            <input name="name" type="text" class="form-control input-sm" value="${(student.name)!}"/>
                        </div>
                    </div><!-- /form-group -->
                    ...
                    <div class="form-group col-md-3" style="margin-right:10px;">
                        ...
                        <div>
                            <input name="studentCode" type="text" class="form-control input-sm" value="${(student.studentCode)!}"/>
                        </div>
                    </div><!-- /form-group -->
                    <div class="form-group col-md-3" style="margin-right:10px;">
                    ...
                    <div class="form-group col-md-3" style="margin-right:10px;">
                        ...
                        <div>
                            <select class="form-control" name="srName">
                                <option value="">请选择</option>
                                <option value="重点积极分子" <#if srName??&&srName == "重点积极分子">selected</#if>>重点积极分子</option>
                                <option value="预备党员" <#if srName??&&srName == "预备党员">selected</#if>>预备党员</option>
                                <option value="正式党员" <#if srName??&&srName == "正式党员">selected</#if>>正式党员</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-3" style="margin-right:10px;">
