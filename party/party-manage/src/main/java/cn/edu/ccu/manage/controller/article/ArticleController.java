...
public class ArticleController extends BaseController {
   ...
   private static final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    @RequestMapping(value = "upload/image/{y}-{m}-{d}/{name}", method = RequestMethod.GET)
    public void ueditorImage(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
