...
public class MainController extends BaseController {
    ...
    public ModelAndView index(HttpServletRequest httpRequest, HttpServletResponse httpResponse, SplitPageRequest splitPageRequest, CourseModel courseModel) throws Exception {
