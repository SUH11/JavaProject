			...
			<div class="hb_setting" >
				...
				<div class="setting_body" >
					<div class="mod_import cl" >
						...
						<div class="upload cl" >
							<form action="testExcel.jsp" method="post" enctype="multipart/form-data">
							...
							<div class="select_file" >
								<div class="excel_area cl" >
									<div class="file_upload" >
										<input type="file" name="upfile" size="50" value="选择文件" class="input-up">
										<p >支持 20MB 以内的 xls、xlsx、csv 文件</p>
										<p >整个文件不超过1万行、200列</p>
									</div>
									<div class="file_drag" >
										<p >或将文件拖拽到这里</p>
										<input class="pn" type="submit" value="提交">
									</div>
								</div>
							</div>
							</form>
