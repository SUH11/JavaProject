							...
							<div class="hb_frame cl">
								<div class="hb_row cl ">
													...
													<div class="scroll">
														<div class="item_view" id="jump">
															<div class="view_mark jump">
																<i></i><b>设置表格及权限</b><cite><i></i>
																</cite><span class="guidepoint gp_install_app_setting"
																	data-tip="在这里调整表格结构和数据的展现形式"><span></span>
																</span>
															</div>
														</div>
														<div class="item_view">
														...
														<div class="item_view" id="jump">
															<div class="view_mark jump">
																<i></i><b>自定义筛选</b><cite><i></i>
																</cite>
															</div>
														</div>
														<div class="item_view" id="jump">
															<div class="view_mark jump">
																<i></i><b>我的共享</b><cite><i></i>
																</cite>
															</div>
														</div>
													</div>
										...
										<div class="hb_itemlist">
											<div class="mod_operations">
												...
												<div class="operation ">
															...
															<div class="popover-content">
																<div class="pop_menu cl">
																	...
																	<ul class="pop_select pop_sequence cl">
																		<li class="">
																			<a href="###" title="创建人，升序">创建人，升序</a>
																		</li>
																		<li class="">
																			<a href="###" title="创建人，降序">创建人，降序</a>
																		</li>
																		<li class="">
																			<a href="###" title="创建时间，最旧的排前">创建时间，最旧的排前</a>
																		</li>
																		<li class="current">
																			<a href="###" title="创建时间，最新的排前">创建时间，最新的排前</a>
																		</li>
																		<li class="">
																			<a href="###" title="修改人，升序">修改人，升序</a>
																		</li>
																		<li class="">
																			<a href="###" title="修改人，降序">修改人，降序</a>
																		</li>
																		<li class="">
																			<a href="###" title="修改时间，最旧的排前">修改时间，最旧的排前</a>
																		</li>
																		<li class="">
																			<a href="###" title="修改时间，最新的排前">修改时间，最新的排前</a>
																		</li>
																		<li class="">
																			<a href="###" title="最后活动时间，最旧的排前">最后活动时间，最旧的排前</a>
																		</li>
																		<li class="">
																			<a href="###" title="最后活动时间，最新的排前">最后活动时间，最新的排前</a>
																		</li>
																	</ul>
																</div>
															</div>
																...
																<div class="pop_menu cl">
																	<div class="pop_tips">
																		...
																		<label style="float: right;"
																			onclick="cancelCheck(event)">
																			<input class="sel_all all_del" type="checkbox"
																				checked="checked" />
																			<span>全选</span>
																		</label>
																	</div>
													...
													<cite> <a data-tip="从Excel新增或更新数据" class=""
														href="tb3.jsp"> <i></i> <span>导入</span> </a> <a
														data-tip="将数据导出为Excel" href="###"><i></i><span>导出</span>
													</a> </cite>
													<cite> <span class="pn_switch pn_switch_off"><span
												...
												<div class="item_search cl">
													<em class="drop"></em>
													<i data-tip="搜索" id="name_search"></i>
														...
														<div class="popover-content">
															<div class="pop_menu cl">
																<div class="pop_tips">
																	...
																	<label style="float: right;"
																		onclick="cancelCheck(event)">
																		<input class="sel_all" type="checkbox"
																			checked="checked" />
																		<span>全选</span>
																	</label>
																</div>
																<ul class="pop_select pop_catlist cl">
																	<li class="current">
																		<span class="mod_category"><a href="#">客户名称</a>
																		</span>
																	</li>
																	<li class="current">
																		<span class="mod_category"><a href="#">预计金额</a>
																		</span>
																	</li>
																	<li class="current">
																		<span class="mod_category"><a href="#">公司地址</a>
																		</span>
																	</li>
																	<li class="current">
																		<span class="mod_category"><a href="#">联系方式</a>
																		</span>
																	</li>
																	<li class="current">
																		<span class="mod_category"><a href="#">备注</a>
																		</span>
																	</li>
																</ul>
															</div>
											...
											<div class="mod_bulkoperation">
												<cite class="cancal_btn"><i></i><span>取消</span>
												</cite><span class="info"><span>已选择</span><strong>1</strong><em><span>/</span><span>1</span>
												</em><span>条数据</span>
												</span><a href="###" class="btn btn_del">删除</a>
											</div>
									...
									<div class="hb_item_footer cl">
										...
										</a><a href="###" data-tip="偏好" class="table_styles"><i></i>
										</a>
		...
		.ready(function($) {
			...
			//页面加载显示所有记录
				...
				function selectAll() {
					$
							.ajax( {
								url : "customerServlet?method=list",
								type : "post",
								asyns : false,
								dataType : "json",
								success : function(msg) {
									...
									$
											.each(
													...
													function(n, value) {
														var id;
														if (value.status == "付款成功") {
															id = 5;
														} else if (value.status == "客户拜访") {
															id = 2;
														} else if (value.status == "合同签订") {
															id = 4;
														} else {
															id = 3;
														}
														var trs = "";
														//加id
														trs = '<tr id="gettr-'+ value.id +'"><td>'
																+ (n + 1)
																+ '</td><td>'
																+ value.name
																+ '</td><td>'
																+ value.source
																+ '</td><td><span class="mod_category catcolor_o color_e" title="'
																+ value.status
																+ '" cid="'
																+ id
																+ '">'
									...
									$("#tb tr").each(function(index, el) {
															$(this).click(function(event) {
																
																if(confirm("是否更改客户信息")){
																	//取得id
																	var getId = $(this).attr("id").split("gettr-")[1];
																	// alert(getId);
																	 location.href = "modifyCustomer.jsp?id="+getId;//location.href实现客户端页面的跳转  
																}
															});
				...
				function getStatus() {
					alert("getStatus");
					$.ajax( {
						url : "statusServlet?method=status&sign=status",
						type : "post",
						asyns : false,
						dataType : "json",
						success : function(msg) {
							$.each(msg, function(n, statusValue) {
								var liList = "";

								liList = '<li class="search-' + (n + 1)
										+ '"><b >' + statusValue
										+ '</b><cite ><i ></i></cite></li>';
						...
						.keydown(function() {
							...
							//alert("键盘事件");
								if (event.keyCode == 13) {
									$
											.ajax( {
												url : "customerServlet?method=search&sign=name&field="
														+ encodeURI(encodeURI($(
																".s_input")
																.val())),
												type : "post",
				...
				function searchClick(getValue) {
					$
							.ajax( {
								//解决中文乱码问题encodeURI(encodeURI("张三"))
								url : "customerServlet?method=search&sign=status&field="
										+ encodeURI(encodeURI(getValue)),
								type : "post",
								dataType : "json",
								success : function(msg) {
									console.log(msg);
				...
				$(".pop_select").find('li').each(
						function(index, el) {
							$(this).on(
									"click",
									function(event) {
										$(this).toggleClass('current').find(
												'span').toggleClass(
												'mod_category')
										$(this).parents(".pop_select")
												.siblings(".pop_tips").find(
														".sel_all").prop(
														'checked', false)
									});
						});
								...
								function(e) {
									...
									if (thnum == 0) {
										$(".tbl")
												...
												.each(
														function(index, el) {
															ullist = lith += "<li class='current'><span class='mod_category'>"
																	+ $(this)
																			.text()
																	+ "</span></li>"
															_this
